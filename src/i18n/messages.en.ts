export const messagesEn = {
  ...
  "common.close": "Close",
  "stat.short.hp": "HP",
  "stat.short.hpPercent": "HP%",
  "stat.short.atk": "ATK",
  "stat.short.atkPercent": "ATK%",
  "stat.short.def": "DEF",
  "stat.short.defPercent": "DEF%",
  "stat.short.spd": "SPD",
  "stat.short.critRate": "CR",
  "stat.short.critDamage": "CD",
  "stat.short.breakEffect": "BE",
  "stat.short.healing": "OHB",
  "stat.short.energyRegen": "ERR",
  "stat.short.effectHit": "EHR",
  "stat.short.effectRes": "RES",
  "stat.short.physicalDamage": "Physical%",
  "stat.short.fireDamage": "Fire%",
  "stat.short.iceDamage": "Ice%",
  "stat.short.lightningDamage": "Lightning%",
  "stat.short.windDamage": "Wind%",
  "stat.short.quantumDamage": "Quantum%",
  "stat.short.imaginaryDamage": "Imaginary%",
  "nav.menu": "Menu",
  ...
  "nav.planning": "Builds",
  "nav.builds": "Character Builds",
  "nav.scoring": "Scoring",
  "nav.filters": "Relic Filters",
  "nav.resources": "Resources",
  "nav.triage": "Relic Triage",
  "nav.archive": "Archive",
  ...
  "route.resources.description":
    "Find promising Relics to level, weak build slots to synthesize, and max-level Relics whose existing substats may justify a Variable Dice review.",
  ...
  "empty.relicsAll":
    "No Relics or Planar Ornaments are present in the local workspace.",
  ...
  "build.legacyTwoPlusTwo":
    "This imported build used two Cavern 2-piece sets. Choose a Cavern set above to convert it to the standard 4+2 layout.",
  "build.addBuild": "Add Build",
  "build.addFirstBuild": "Add First Build",
  "build.scoringConfigure": "Configure scoring weights and grade thresholds",
  "build.fixedMainStat": "Fixed main stat",
  ...
  "triage.filterCategory": "Equipment type",
  "triage.category.cavern": "Cavern Relics",
  "triage.category.planar": "Planar Ornaments",
  "triage.all": "All",
  "triage.keep": "Keep",
  "triage.review": "Review",
  "triage.salvageReview": "Salvage review",
  "triage.matchingBuilds": "Matches {count} builds",
  "triage.visibleCount": "Showing {shown} of {total} imported Relics",
  ...
  "resource.suggestionCount": "Suggestions: {count}",
  "resource.filterAction": "Action",
  "resource.filterCategory": "Equipment",
  "resource.filterSet": "Relic set",
  "resource.filterPriority": "Opportunity",
  "resource.category.cavern": "Cavern Relic",
  "resource.category.planar": "Planar Ornament",
  "resource.priority.high": "Largest gaps",
  ...
  "resource.scoreGap": "Headroom {value}",
  "resource.levelDetail":
    "Level +{current} → +{target}. Current score {before}; optimistic ceiling {ceiling} applies the strongest eligible weight to every remaining +3 enhancement. Actual substats and rolls may score lower.",
  "resource.synthesizeStandardDetail":
    "Standard synthesis: {remains} Relic Remains. Head and Hands already have fixed main stats, so no Self-Modeling Resin is assumed.",
  "resource.synthesizeCustomDetail":
    "Customized synthesis: {remains} Relic Remains + {resin} Self-Modeling Resin to select this main stat. Substat outcomes remain random.",
  "resource.rerollDetail":
  ...
  "characterLoadout.filters": "Character filters",
  "characterLoadout.clearFilters": "Clear filters",
  "characterLoadout.cardLabel": "{name} loadout",
  "characterLoadout.openArchive": "Open {name} in the Character Archive",
  "characterLoadout.lightCone": "Light Cone",
  "characterLoadout.noLightCone": "No Light Cone equipped",
  "characterLoadout.setSummary": "Equipped set summary",
  "characterLoadout.cavernSets": "Cavern Relic sets",
  "characterLoadout.planarSets": "Planar Ornament sets",
  "characterLoadout.noSet": "No equipped set pieces",
  "characterLoadout.pieceCount": "{count}-piece",
  "characterLoadout.relics": "Equipped Relics",
  "characterLoadout.relicSlotLabel": "{slot} Relic slot",
  "characterLoadout.emptySlot": "Empty slot",
  "characterLoadout.aggregateScore": "Average Relic score",
  ...
  "inventory.section.lightCones": "Light Cones",
  "inventory.section.relics": "Relics and Planar Ornaments",
  "inventory.charactersList": "Inventory Character results",
  "inventory.lightConesList": "Inventory Light Cone results",
  "inventory.relicsList": "Inventory Relic results",
  "inventory.quickFilters": "Relic quick filters",
  "inventory.category.cavern": "Cavern Relics",
  "inventory.category.planar": "Planar Ornaments",
  "inventory.filter.equipment": "Equipment",
  "inventory.level.max": "Max level",
  "inventory.level.enhanced": "Enhanced",
  "inventory.level.zero": "+0",
  "filter.path": "Path",
  "filter.combatType": "Combat Type",
  "filter.category": "Relic type",
  "filter.level": "Level",
  "filter.set": "Set",
  "filter.slot": "Slot",
  ...
  "tier.priority.role.support": "Support",
  "tier.priority.role.other": "Other",
