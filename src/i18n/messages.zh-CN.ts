...
export const messagesZhCn = {
  ...
  "common.close": "关闭",
  "stat.short.hp": "生命",
  "stat.short.hpPercent": "生命%",
  "stat.short.atk": "攻击",
  "stat.short.atkPercent": "攻击%",
  "stat.short.def": "防御",
  "stat.short.defPercent": "防御%",
  "stat.short.spd": "速度",
  "stat.short.critRate": "暴击",
  "stat.short.critDamage": "爆伤",
  "stat.short.breakEffect": "击破",
  "stat.short.healing": "治疗",
  "stat.short.energyRegen": "充能",
  "stat.short.effectHit": "命中",
  "stat.short.effectRes": "抵抗",
  "stat.short.physicalDamage": "物伤",
  "stat.short.fireDamage": "火伤",
  "stat.short.iceDamage": "冰伤",
  "stat.short.lightningDamage": "雷伤",
  "stat.short.windDamage": "风伤",
  "stat.short.quantumDamage": "量子",
  "stat.short.imaginaryDamage": "虚数",
  "nav.menu": "菜单",
  ...
  "route.resources.title": "资源",
  "route.resources.description":
    "找出值得强化的遗器、适合定向合成的薄弱部位，以及副词条类型优秀但强化分配欠佳、可考虑使用变量骰子的满级遗器。",
  ...
  "empty.relicsAll": "本地工作区中没有遗器或位面饰品。",
  ...
  "build.legacyTwoPlusTwo":
    "这套导入配装使用了两组隧洞遗器 2 件套。请在上方选择一套隧洞遗器，将其转换为标准 4+2 配装。",
  "build.addBuild": "添加配装",
  "build.addFirstBuild": "添加首套配装",
  "build.scoringConfigure": "配置评分权重与评级门槛",
  "build.fixedMainStat": "固定主词条",
  ...
  "triage.filterCategory": "装备类型",
  "triage.category.cavern": "隧洞遗器",
  "triage.category.planar": "位面饰品",
  "triage.all": "全部",
  "triage.keep": "保留",
  "triage.review": "人工复核",
  "triage.salvageReview": "分解复核",
  "triage.matchingBuilds": "匹配 {count} 套配装",
  "triage.visibleCount": "显示 {shown} / {total} 件已导入遗器",
  ...
  "resource.filterAction": "操作",
  "resource.filterCategory": "装备类型",
  "resource.filterSet": "遗器套装",
  "resource.filterPriority": "提升空间",
  "resource.category.cavern": "隧洞遗器",
  "resource.category.planar": "位面饰品",
  "resource.priority.high": "空间较大",
  ...
  "resource.scoreGap": "评分空间 {value}",
  "resource.levelDetail":
    "强化 +{current} → +{target}。当前分数 {before}；乐观上限 {ceiling} 假设后续每次 +3 强化都落在权重最高的可用词条上，实际词条与强化结果可能更低。",
  "resource.synthesizeStandardDetail":
    "普通合成：{remains} 个遗器残骸。头部和手部主词条固定，因此不计入自塑尘脂。",
  "resource.synthesizeCustomDetail":
    "定向合成：{remains} 个遗器残骸 + {resin} 个自塑尘脂，用于选择该主词条；副词条结果仍为随机。",
  ...
  "characterLoadout.filters": "角色筛选",
  "characterLoadout.clearFilters": "清除筛选",
  "characterLoadout.cardLabel": "{name} 的配装",
  "characterLoadout.openArchive": "在角色图鉴中查看{name}",
  "characterLoadout.lightCone": "光锥",
  "characterLoadout.noLightCone": "未装备光锥",
  "characterLoadout.setSummary": "已装备套装汇总",
  "characterLoadout.cavernSets": "隧洞遗器套装",
  "characterLoadout.planarSets": "位面饰品套装",
  "characterLoadout.noSet": "没有已装备的套装部件",
  "characterLoadout.pieceCount": "{count} 件套",
  "characterLoadout.relics": "已装备遗器",
  "characterLoadout.relicSlotLabel": "遗器部位：{slot}",
  "characterLoadout.emptySlot": "未装备",
  ...
  "inventory.section.lightCones": "光锥",
  "inventory.section.relics": "遗器与位面饰品",
  "inventory.charactersList": "背包角色结果",
  "inventory.lightConesList": "背包光锥结果",
  "inventory.relicsList": "背包遗器结果",
  "inventory.quickFilters": "遗器快捷筛选",
  "inventory.category.cavern": "隧洞遗器",
  "inventory.category.planar": "位面饰品",
  "inventory.filter.equipment": "装备情况",
  "inventory.level.max": "已满级",
  "inventory.level.enhanced": "已强化",
  "inventory.level.zero": "+0",
  "filter.path": "命途",
  "filter.combatType": "战斗属性",
  "filter.category": "遗器类型",
  "filter.level": "等级",
  "filter.set": "套装",
  "filter.slot": "部位",
  "filter.status": "状态",
  ...
  "tier.priority.role.support": "辅助",
  "tier.priority.role.other": "其他",
